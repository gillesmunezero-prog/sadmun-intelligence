# Dossier Commercial — Accelerating Sustainable and Clean Energy Access Transformation in Mozambique

**ID Projet (Banque Mondiale) :** P512418
**Statut :** Actif — Board Approved (12 decembre 2025)
**Bailleur :** Banque Mondiale
**Emprunteur :** A qualifier (N/A sur la fiche publique au 11/08/2026)
**Organisme d'execution :** A qualifier (N/A sur la fiche publique au 11/08/2026)
**Engagement :** US$ 400 millions (le plus gros des 10 projets suivis)
**Secteurs :** Administration publique — Energie ; Reseaux et stockage d'energie
**Services de consultants requis :** Oui
**Risque environnemental et social :** Substantiel (S)
**Projet parent :** P507759 (Accelerating Sustainable and Clean Energy Access Transformation in Mozambique — phase precedente)
**Lien officiel :** https://projects.worldbank.org/en/projects-operations/project-detail/P512418

> Source : projects.worldbank.org, consulte le 11/08/2026. Confiance : **Eleve** pour les donnees chiffrees. Statut : **Verifie**. Emprunteur/agence d'execution : **A qualifier**.

## 1. Resume du projet

Projet lie a P507759 (phase anterieure du meme programme), visant a
accelerer l'acces a une energie durable et propre au Mozambique. Fait partie
d'un programme de grande ampleur sur le secteur electrique et les energies
renouvelables.

## 2. Analyse IA

- **Analyse des risques :** montant tres eleve (US$400M) = probable
  multiplicite de sous-projets et de contractants ; risque E&S substantiel
  (probable lie a des infrastructures de transmission/distribution).
- **Besoins locaux :** deploiement d'infrastructures electriques en zones
  urbaines et rurales, raccordement de nouveaux foyers/entreprises.
- **Besoins logistiques :** tres importants compte tenu de l'echelle —
  transport d'equipements, hebergement d'equipes techniques nombreuses,
  vehicules en grand nombre.
- **Besoins administratifs :** permitting pour installations electriques,
  coordination avec EDM (Electricidade de Mocambique) probable.
- **Besoins communautaires :** sensibilisation a l'electrification, gestion
  des impacts fonciers pour les lignes de transmission.
- **Besoins environnementaux :** etudes d'impact pour lignes haute tension et
  installations de production.

*(Analyse deductive, agence d'execution non confirmee publiquement — a
reverifier des que l'information sera publiee.)*

## 3. Opportunites pour SADMUN

**Pourquoi ce projet nous interesse :** le plus gros volume des 10 projets
suivis (US$400M) ; secteur energie tres actif au Mozambique ; probable
multiplicite de sous-contractants internationaux ayant besoin d'appui local.

**Ce que nous pouvons vendre :** logistique de chantier a grande echelle,
recrutement local massif, hebergement d'equipes techniques, vehicules,
administration/permitting local, traduction technique.

**Ce que nous ne pouvons pas vendre :** ingenierie electrique,
equipements de reseau, EPC (Engineering-Procurement-Construction).

**Partenaires a rechercher :** EDM (si confirme comme partenaire local),
entreprises d'EPC electrique presentes au Mozambique.

**Competences a acquerir :** connaissance des normes de securite
electrique et des procedures de raccordement reseau mozambicaines.

## 4. Entreprises cibles — score de ciblage

> Confiance : **Faible**. Agence d'execution non confirmee au 11/08/2026 ;
> ciblage par analogie sectorielle uniquement.

| Entreprise | Type | Score | Justification |
|---|---|---|---|
| Electricidade de Mocambique (EDM) | Utilite publique / partenaire local | 65 | Acteur incontournable du secteur electrique mozambicain (deja implementing agency du projet P179797, cf. dossier 10). |
| Scatec / Globeleq / entreprises d'energie renouvelable actives en Afrique australe | Entreprises internationales | 50 | Profil sectoriel type pour des projets d'acces a l'energie propre en Afrique australe, presence non confirmee sur ce projet precis. |
| Sinohydro / entreprises EPC chinoises | Entreprises internationales | 45 | Frequemment presentes sur des projets d'infrastructure electrique en Afrique, a confirmer. |

## 5. Decideurs

| Nom | Fonction | Organisation | Source | Confiance | Statut |
|---|---|---|---|---|---|
| Jenny Chao | Team Leader (Banque Mondiale) | Banque Mondiale | projects.worldbank.org/P512418 | Eleve | Verifie |
| A qualifier | Responsable EDM / MIREME sur ce projet | A qualifier | — | — | A qualifier |

## 6. Strategie de prospection

**Qui contacter en premier :** EDM et le Ministere des Ressources
Minerales et de l'Energie (MIREME), une fois confirmes comme parties
prenantes officielles du projet.

**Quand relancer :** a la publication de l'agence d'execution officielle et
du plan de passation de marches.

## 7. Message de prospection (a adapter)

> Bonjour,
>
> Nous suivons le projet "Accelerating Sustainable and Clean Energy Access
> Transformation in Mozambique" (P512418), finance par la Banque Mondiale a
> hauteur de US$400M. SADMUN accompagne les acteurs du secteur energie au
> Mozambique sur : logistique, administration, community engagement,
> permitting, recrutement local, hebergement, vehicules, traduction. Nous
> souhaiterions echanger avec la personne en charge de ce projet.

## 8. Plan d'action

- **Aujourd'hui :** verifier la publication de l'implementing agency.
- **Cette semaine :** rechercher les communiques EDM/MIREME lies a ce
  financement.
- **Ce mois :** identifier les grands EPC electriques deja actifs au
  Mozambique (veille sectorielle).
- **Avant la cloture :** N/A (date de cloture non publiee).
- **Apres attribution :** approcher les contractants EPC retenus pour leur
  offrir un appui logistique/administratif local.

## 9. CRM (suivi)

| Date | Action | Resultat | Prochaine relance | Probabilite | Commentaires |
|---|---|---|---|---|---|
| A completer | — | — | — | — | Dossier cree le 11/08/2026. |

## 10. Historique SADMUN sur projets similaires

*A completer par Gilles.*

## 11. Documents et liens officiels

- https://projects.worldbank.org/en/projects-operations/project-detail/P512418

## 12. Sources utilisees

- projects.worldbank.org — fiche P512418, consultee le 11/08/2026.
